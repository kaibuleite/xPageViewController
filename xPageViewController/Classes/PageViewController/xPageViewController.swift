...
public class xPageViewController: UIPageViewController {
    ...
    public class func xDefaultViewController(navigationOrientation: UIPageViewController.NavigationOrientation) -> Self
    {
        let vc = xPageViewController.init(transitionStyle: .scroll,
                       ...
                       click handler2 : @escaping xHandlerClickPage)
    {
        ...
        for url in webImageArray {
            let vc = xImageItemViewController.xDefaultViewController()
            vc.webImage = url
            vcArray.append(vc)
        }
